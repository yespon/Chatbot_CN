...
<p align="center">基于深度学习、强化学习、开源RASA对话引擎的多场景对话机器人</p>
...
<p align="center">
    <img src="https://github.com/charlesXu86/Chatbot_CN/blob/master/image/chatbot.jpg?raw=true" width="500 height=500">
</p>
...
目前**Chatbot_CN** 已经拆分成了13个子项目，涵盖了对话数据收集处理、基本算法模型（句法分析、细粒度情感分析、实体抽取、query纠错等）、对话引擎（自然语言理解、对话管理、对话策略、策略优化）、对话质量评估，第三方平台快速接入、数据回流、模型优化等等。具体的项目结构请参考项目结构和各模块详细说明。
...
<details>
 <summary>当你熟悉了项目的整体架构后，你还需要对其各个子模块进行详细的了解，这样你才能对机器人的机制有一个深刻的理解(点击展开。。。)</summary>
