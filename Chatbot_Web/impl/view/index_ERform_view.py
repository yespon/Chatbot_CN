...
import sys
sys.path.append("..")
from Chatbot_KG.toolkit.pre_load import pre_load_thu,neo_con,predict_labels
from Chatbot_KG.toolkit.NER import get_NE,temporaryok,get_explain,get_detail_explain
